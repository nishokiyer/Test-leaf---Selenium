...
public class Amazon_Kart_Assignment6 {
...
//3.Get the price of the first product
	...
	System.out.println("The Price of the first Product displayed is : " +ProductPrice);	

//4. Print the number of customer ratings for the first displayed product
//5. click on the stars 
	List<WebElement> startRating = driver.findElements(By.xpath("//i/span[@class='a-icon-alt']"));
	Actions action = new Actions(driver);
	action.moveToElement(startRating.get(0)).click().perform();
